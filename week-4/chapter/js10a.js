...
function setupRoom() {
   ...
   let startingX = 0;                                                     // Initial pointer x coordinate
   let startingY = 0;                                                     // Initial pointer y coordinate
   let tableX = 0;                                                        // Initial table x coordinate
   let tableY = 0;                                                        // Initial table y coordinate
   ...
   function countSeats() {
    ...
    for (let items of storageTables) {
      items.onclick = function() {
        ...
        // Grab the table in response to teh pointer down event
        storageCopy.addEventListener("pointerdown", grabTable);
      }
    }

    // Grab a table from teh banquet hall
